...
namespace ValiProyecto.Controllers
{
    public class VentasController : Controller
    {
        ...
        public VentasController(ProyectoValiContext context)
        {
            _context = context;
        }
        // GET: Ventas
        ...
        {
            var proyectoValiContext = _context.Ventas.Include(v => v.Cliente);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoValiContext.Ventas'  is null.");
            }
            var venta = await _context.Ventas.FindAsync(id);
            if (venta != null)
            {
