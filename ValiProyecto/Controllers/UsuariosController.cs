...
namespace ValiProyecto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ProyectoValiContext context)
        {
            _context = context;
        }
        // GET: Usuarios
        public async Task<IActionResult> Index()
        {
              return _context.Usuarios != null ? 
                          ...
                          Problem("Entity set 'ProyectoValiContext.Usuarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoValiContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
